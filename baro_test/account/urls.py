...
from account.views import test, AccountCreateView, AccountDetailView, AccountUpdateView, AccountPasswordUpdateView, AccountDeleteView
...
urlpatterns = [
    ...
    path('mypage/<str:pk>', AccountDetailView.as_view(), name='detail'),
